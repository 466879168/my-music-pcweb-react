...
import {formatMouthDay} from '@/utils/format-utils'
import MYSongOperationBar from '@/components/song-operation-bar'

import {RankingHeaderWrapper} from './style'

export default memo(function MYRankingHeader() {
  ...
  return (
    <RankingHeaderWrapper>
      <div className="image">
        ...
        <span className="cover_image">封面</span>
      </div>
      <div className="info">
